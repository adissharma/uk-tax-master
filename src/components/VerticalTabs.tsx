        ...
        <div>
          {tabs.map((tab) => (
            <button
              ...
              className={cn(
                'block w-full text-left px-4 py-3 text-base font-medium border-l-4 transition-colors relative ml-2',
                'focus:outline-none focus:ring-4 focus:ring-govuk-blue focus:ring-offset-0',
                activeTab === tab.id
                  ? 'border-primary bg-accent text-primary rounded-r-lg'
                  : 'border-transparent text-foreground hover:border-muted-foreground hover:bg-muted rounded-r-lg'
              )}
